...
/* Private typedef -----------------------------------------------------------*/
typedef struct{
  uint16_t  CustomArmHdle;                    /**< Server_Arm handle */
  uint16_t  CustomGoal_CHdle;                  /**< Goal_Char handle */
  uint16_t  CustomState_CHdle;                  /**< State_Char handle */
 ...
 */
#define COPY_SERVER_ARM_UUID(uuid_struct)          COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x40,0xcc,0x7a,0x48,0x2a,0x98,0x4a,0x7f,0x2e,0xd5,0xb3,0xe5,0x8f)
#define COPY_GOAL_CHAR_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x41,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
#define COPY_STATE_CHAR_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x42,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
...
void SVCCTL_InitCustomSvc(void)
{
   ...
   * service_max_attribute_record = 1 for Server_Arm +
   *                                2 for Goal_Char +
   *                                2 for State_Char +
   *                                1 for State_Char configuration descriptor +
   *                              = 6
   *
...
tBleStatus Custom_STM_App_Update_Char(Custom_STM_Char_Opcode_t CharOpcode, uint8_t *pPayload)
{
  ...
  switch (CharOpcode)
  {
    ...
    case CUSTOM_STM_STATE_C:
      ret = aci_gatt_update_char_value(CustomContext.CustomArmHdle,
                                       CustomContext.CustomState_CHdle,
                                       0, /* charValOffset */
                                       SizeState_C, /* charValueLen */
                                       (uint8_t *)  pPayload);
      if (ret != BLE_STATUS_SUCCESS)
      {
